...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ id, name, label, error, helperText, className, required, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          className={cn(
            'w-full h-12 px-4 rounded-sm bg-surface border border-border text-primary-text placeholder:text-primary-muted/60 text-sm font-sans',
